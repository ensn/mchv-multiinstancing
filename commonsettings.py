clicks=(                #windowed, small GUI
    (950, 392),         #save and quit
    (950, 330),         #singleplayer
    (1040, 990),        #create new world
    (950, 200),         #more world options (set seed)
...
clicks=(                #windowed, normal GUI
    ...
    (1110, 950),        #create new world
    (950, 390),         #more world options (set seed)
...
clicks=(                #fullscreen/borderless, large GUI
    (950, 623),         #save and quit
    (950, 450),         #singleplayer
    (1200, 950),        #create new world
    (950, 570),         #more world options (set seed)
    (950, 230),         #seed box (set seed)
    (700, 1020))        #create new world

pixeldata=(             #for visual_cue setting (borderless, large GUI)
    (586, 94),          #position
    (165, 156, 153))    #rgb colour

clicks=(                #windowed, auto GUI
    (950, 750),         #save and quit
    (950, 500),         #singleplayer
    (1300, 870),        #create new world
    (950, 750),         #more world options (set seed)
...
clicks=(                #fullscreen/borderless, auto GUI
    ...
    (1300, 910),        #create new world
    (950, 730),         #more world options (set seed)
    (950, 280),         #seed box (set seed)
    (650, 1010))        #create new world

pixeldata=(             #for visual_cue setting (borderless, auto GUI)
    (462, 126),         #position
    (165, 156, 153))    #rgb colour
